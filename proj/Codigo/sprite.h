...
typedef struct {
  ...
  uint8_t direction;       //0->esquerda para direita; 1->direita para esquerda; 2-> cima para baixo; 3-> baixo para cima;
...
void changeXY(Sprite *sp, int x, int y);

void changeDirection(Sprite *sp, uint8_t dir);

//define a largura e altura do sprite
